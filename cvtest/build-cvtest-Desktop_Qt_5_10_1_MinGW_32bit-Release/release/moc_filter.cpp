...
QT_MOC_LITERAL(1, 7, 14), // "SrcHasFiltered"
QT_MOC_LITERAL(2, 22, 0) // ""

    },
    "filter\0SrcHasFiltered\0"
};
...
void filter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->SrcHasFiltered(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (filter::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&filter::SrcHasFiltered)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject filter::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_filter.data,
      qt_meta_data_filter,  qt_static_metacall, nullptr, nullptr}
};
...
void *filter::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "cv2qt"))
        return static_cast< cv2qt*>(this);
